...
import com.lovelycatv.relink.std.*
import com.lovelycatv.relink.std.ir.pure.IrDivNode
import com.lovelycatv.relink.std.runtime.executor.NodeExecutor

import com.lovelycatv.relink.std.runtime.type.*

object DivExecutor : NodeExecutor<IrDivNode> {
    override suspend fun execute(
        node: IrDivNode,
        inputs: Map<PortLabel, RuntimeValue>
    ): Map<PortLabel, RuntimeValue> {
        val x = inputs[IrDivNode.INPUT_X]!!
        val y = inputs[IrDivNode.INPUT_Y]!!
        ...
        return mapOf(IrDivNode.OUTPUT_Z to z)
    }
}
